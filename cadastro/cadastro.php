    ...
    <body>
        ...
        <section id="header">
            <header class="major">
                ...
                <p>Precisamos de informações para traçar seu perfil.</p>
            </header>
            <div class="container">
                <ul class="actions">
        ...
        <section id="one" class="main special">
            <div class="container">
                <span class="image fit primary"><img src="images/car_lights.jpg" alt="" /></span>
                <div class="content">
                    <header class="major">
                    ...
                    <div class="inner">
                        <form action="#" method="POST">
                                <div class="row uniform 50%">
                                    ...
                                    <div class="12u$">
                                        <input name="sNome" placeholder="Sobrenome" type="text" />
                                    </div>
                                    <div class="12u$">
        ...
        <section id="two" class="main special">
            <div class="container">
                <span class="image fit primary"><img src="images/tunel.jpg" alt="" /></span>
                <div class="content">
                    <header class="major">
        ...
        <section id="three" class="main special">
            <div class="container">
                <span class="image fit primary"><img src="images/urban.jpg" alt="" /></span>
                <div class="content">
                    <header class="major">
